...
pub mod exports_funcs {
    ...
    pub fn get_get_random_bytes<T, E: backend::WasmEngine>(
        instance: &Instance,
        _store: &mut Store<T, E>,
    ) -> Result<TypedFunc<u32, Vec<u8>>> {
        ...
        interface
            .func("get-random-bytes")
            .ok_or_else(|| anyhow!("Function 'get-random-bytes' not found"))?
            .typed::<u32, Vec<u8>>()
    }
